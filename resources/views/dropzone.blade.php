            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form method="POST" action="{{ route('dropzone.store') }}" enctype="multipart/form-data" class="dropzone dz-clickable"
                                id="image-upload">
                                @csrf
                                <div>
                                    <h3 class="text-center"> Upload Image By Click on Box</h3>
                                </div>
                                <div class="dz-defualt dz-message"><span>Drop files here to Upload</span></div>
                            </form>
                        </div>
                    </div>
                </div>
